...
- [ ] 5. Add Qwen-token denoiser scaffold with tiny CPU smoke mode.
...
- [ ] 7. Add Qwen-token training smoke loop.
...
- [ ] 8. Add expanded eval buckets and conservative capability reports.
...
- [ ] 10. Add automated train-validation-repeat loop runner.
...
- [ ] 11. Add chat and tool-agent schema/eval stubs that feed the same loop.
...
- [ ] 12. Add final conservative release/capability gate and iteration policy.
